...
class Register extends Component {
  ...
  socialSignUp = (response, platform) => {
    API.response(response, platform)
      .then(response => {
        this.props.setCurrent(response.data.token);
        this.props.history.push("/dashboard");
      })
        ...
        <CardContent>
          ...
          <form className={classes.container} noValidate autoComplete="off">
            ...
            <GoogleLogin
              ...
              onSuccess={response => this.socialSignUp(response, "google")}
              onFailure={response => this.socialSignUp(response, "google")}
            >
            ...
            <FacebookLogin
              ...
              callback={response => this.socialSignUp(response, "facebook")}
